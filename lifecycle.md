...
| `cancelled_at` | `timestampTz` | Lifecycle timestamp |
| `delivery_failed_at` | `timestampTz` | Lifecycle timestamp |
...
`cancelled_at` and `delivery_failed_at` have been added in migration 2001_02_01_000008.

### P3 — ~~Missing lifecycle timestamp on `return_authorizations`~~

`cancelled_at` has been added in migration 2001_02_01_000009.
...
delivery_failed_at    timestampTz     [existing]
